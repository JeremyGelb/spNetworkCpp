...
#' @export
#'
discontinuous_nkde_cpparma <- function(neighbour_list, events, weights, samples, bw, kernel_name, nodes, line_list, max_depth, verbose) {
    .Call('_spNetworkCpp_discontinuous_nkde_cpparma', PACKAGE = 'spNetworkCpp', neighbour_list, events, weights, samples, bw, kernel_name, nodes, line_list, max_depth, verbose)
}
